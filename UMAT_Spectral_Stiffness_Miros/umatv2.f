     ...
     3     PROPS(NPROPS),COORDS(3),DROT(3,3),DFGRD0(3,3),DFGRD1(3,3)
      ...
      integer getpid, test_id, myid, ierr, numcpu
       ...
       parameter NCRYS=1000,SUP_IND=30,PI=3.14159265358979323846264,
...
C
     ...
     # index_El_i,index_El_i_aux,Fo_C_real,Fo_C_imag,C)
      ...
      !-----------------
       parameter SUP_IND=30,CI=(0.0,1.0),PI=3.141592653589793238462643
...
#ifdef OMP 
!$omp parallel do private(tempSuper) 
!$omp& erduction(+:Ftemp)
#elif GPU
!$ACC kernels
!$ACC loop private(i,ii,tempSuper)
#endif 
 do i=1,NCRYS
...
#elif Array_Scalar_Version


 
#ifdef OMP 
!$omp parallel do private(tempSuper) 
!$omp& reduction(+:FTerm1,FTerm2,FTerm3,FTerm4,FTerm5)
!$omp& reduction(+:FTerm6,FTerm7,FTerm8,FTerm9,FTerm10)
!$omp& reduction(+:FTerm11,FTerm12,FTerm13,FTerm14,FTerm15) 
!$omp& reduction(+:FTerm16,FTerm17,FTerm18,FTerm19,FTerm20) 
!$omp& reduction(+:FTerm21,FTerm22,FTerm23,FTerm24,FTerm25) 
!$omp& reduction(+:FTerm26,FTerm27,FTerm28,FTerm29,FTerm30) 
!$omp& reduction(+:FTerm31,FTerm32,FTerm33,FTerm34,FTerm35) 
!$omp& reduction(+:FTerm36,FTerm37,FTerm38,FTerm39,FTerm40) 
!$omp& reduction(+:FTerm41,FTerm42,FTerm43,FTerm44,FTerm45) 
!$omp& reduction(+:FTerm46,FTerm47,FTerm48,FTerm49,FTerm50) 
!$omp& reduction(+:FTerm51,FTerm52,FTerm53,FTerm54,FTerm55) 
!$omp& reduction(+:FTerm56,FTerm57,FTerm58,FTerm59,FTerm60) 
!$omp& reduction(+:FTerm61,FTerm62,FTerm63,FTerm64,FTerm65) 
!$omp& reduction(+:FTerm66,FTerm67,FTerm68,FTerm69,FTerm70) 
!$omp& reduction(+:FTerm71,FTerm72,FTerm73,FTerm74,FTerm75) 
!$omp& reduction(+:FTerm76,FTerm77,FTerm78,FTerm79,FTerm80) 
!$omp& reduction(+:FTerm81,FTerm82,FTerm83,FTerm84,FTerm85) 
!$omp& reduction(+:FTerm86,FTerm87,FTerm88,FTerm89,FTerm90) 
!$omp& reduction(+:FTerm91,FTerm92,FTerm93,FTerm94)
#elif GPU
!$ACC kernels
!$ACC loop private(i,ii,tempSuper)
#endif 
...
c          if(frequency(i).ne.0)then
     ...
     #exp(-2.0*PI*CI/360.0*tempSuper(ii))
      ...
      FTerm1=FTerm1+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(1))
      FTerm2=FTerm2+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(2))
      FTerm3=FTerm3+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(3))
      FTerm4=FTerm4+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(4))
      FTerm5=FTerm5+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(5))
      FTerm6=FTerm6+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(6))
      FTerm7=FTerm7+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(7))
      FTerm8=FTerm8+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(8))
      FTerm9=FTerm9+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(9))
      FTerm10=FTerm10+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(10))
      FTerm11=FTerm11+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(11))
      FTerm12=FTerm12+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(12))
      FTerm13=FTerm13+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(13))
      FTerm14=FTerm14+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(14))
      FTerm15=FTerm15+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(15))
      FTerm16=FTerm16+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(16))
      FTerm17=FTerm17+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(17))
      FTerm18=FTerm18+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(18))
      FTerm19=FTerm19+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(19))
      FTerm20=FTerm20+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(20))
      FTerm21=FTerm21+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(21))
      FTerm22=FTerm22+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(22))
      FTerm23=FTerm23+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(23))
      FTerm24=FTerm24+dfloat(frequency(i))*
     #exp(-2.0*PI*CI/360.0*tempSuper(24))
      Fterm25=Fterm25+dfloat(frequency(25))
     #*exp(-2.0*PI*CI/360.0*tempSuper(25))
      Fterm26=Fterm26+dfloat(frequency(26))
     #*exp(-2.0*PI*CI/360.0*tempSuper(26))
      Fterm27=Fterm27+dfloat(frequency(27))
     #*exp(-2.0*PI*CI/360.0*tempSuper(27))
      Fterm28=Fterm28+dfloat(frequency(28))
     #*exp(-2.0*PI*CI/360.0*tempSuper(28))
      Fterm29=Fterm29+dfloat(frequency(29))
     #*exp(-2.0*PI*CI/360.0*tempSuper(29))
      Fterm30=Fterm30+dfloat(frequency(30))
     #*exp(-2.0*PI*CI/360.0*tempSuper(30))
#if 0
      Fterm31=Fterm31+dfloat(frequency(31))
     #*exp(-2.0*PI*CI/360.0*tempSuper(31))
      Fterm32=Fterm32+dfloat(frequency(32))
     #*exp(-2.0*PI*CI/360.0*tempSuper(32))
      Fterm33=Fterm33+dfloat(frequency(33))
     #*exp(-2.0*PI*CI/360.0*tempSuper(33))
      Fterm34=Fterm34+dfloat(frequency(34))
     #*exp(-2.0*PI*CI/360.0*tempSuper(34))
      Fterm35=Fterm35+dfloat(frequency(35))
     #*exp(-2.0*PI*CI/360.0*tempSuper(35))
      Fterm36=Fterm36+dfloat(frequency(36))
     #*exp(-2.0*PI*CI/360.0*tempSuper(36))
      Fterm37=Fterm37+dfloat(frequency(37))
     #*exp(-2.0*PI*CI/360.0*tempSuper(37))
      Fterm38=Fterm38+dfloat(frequency(38))
     #*exp(-2.0*PI*CI/360.0*tempSuper(38))
      Fterm39=Fterm39+dfloat(frequency(39))
     #*exp(-2.0*PI*CI/360.0*tempSuper(39))
      Fterm40=Fterm40+dfloat(frequency(40))
     #*exp(-2.0*PI*CI/360.0*tempSuper(40))
      Fterm41=Fterm41+dfloat(frequency(41))
     #*exp(-2.0*PI*CI/360.0*tempSuper(41))
      Fterm42=Fterm42+dfloat(frequency(42))
     #*exp(-2.0*PI*CI/360.0*tempSuper(42))
      Fterm43=Fterm43+dfloat(frequency(43))
     #*exp(-2.0*PI*CI/360.0*tempSuper(43))
      Fterm44=Fterm44+dfloat(frequency(44))
     #*exp(-2.0*PI*CI/360.0*tempSuper(44))
      Fterm45=Fterm45+dfloat(frequency(45))
     #*exp(-2.0*PI*CI/360.0*tempSuper(45))
      Fterm46=Fterm46+dfloat(frequency(46))
     #*exp(-2.0*PI*CI/360.0*tempSuper(46))
      Fterm47=Fterm47+dfloat(frequency(47))
     #*exp(-2.0*PI*CI/360.0*tempSuper(47))
      Fterm48=Fterm48+dfloat(frequency(48))
     #*exp(-2.0*PI*CI/360.0*tempSuper(48))
      Fterm49=Fterm49+dfloat(frequency(49))
     #*exp(-2.0*PI*CI/360.0*tempSuper(49))
      Fterm50=Fterm50+dfloat(frequency(50))
     #*exp(-2.0*PI*CI/360.0*tempSuper(50))



      Fterm51=Fterm51+dfloat(frequency(51))
     #*exp(-2.0*PI*CI/360.0*tempSuper(51))
      Fterm52=Fterm52+dfloat(frequency(52))
     #*exp(-2.0*PI*CI/360.0*tempSuper(52))
      Fterm53=Fterm53+dfloat(frequency(53))
     #*exp(-2.0*PI*CI/360.0*tempSuper(53))
      Fterm54=Fterm54+dfloat(frequency(54))
     #*exp(-2.0*PI*CI/360.0*tempSuper(54))
      Fterm55=Fterm55+dfloat(frequency(55))
     #*exp(-2.0*PI*CI/360.0*tempSuper(55))
      Fterm56=Fterm56+dfloat(frequency(56))
     #*exp(-2.0*PI*CI/360.0*tempSuper(56))
      Fterm57=Fterm57+dfloat(frequency(57))
     #*exp(-2.0*PI*CI/360.0*tempSuper(57))
      Fterm58=Fterm58+dfloat(frequency(58))
     #*exp(-2.0*PI*CI/360.0*tempSuper(58))
      Fterm59=Fterm59+dfloat(frequency(59))
     #*exp(-2.0*PI*CI/360.0*tempSuper(59))
      Fterm60=Fterm60+dfloat(frequency(60))
     #*exp(-2.0*PI*CI/360.0*tempSuper(60))
      Fterm61=Fterm61+dfloat(frequency(61))
     #*exp(-2.0*PI*CI/360.0*tempSuper(61))
      Fterm62=Fterm62+dfloat(frequency(62))
     #*exp(-2.0*PI*CI/360.0*tempSuper(62))
      Fterm63=Fterm63+dfloat(frequency(63))
     #*exp(-2.0*PI*CI/360.0*tempSuper(63))
      Fterm64=Fterm64+dfloat(frequency(64))
     #*exp(-2.0*PI*CI/360.0*tempSuper(64))
      Fterm65=Fterm65+dfloat(frequency(65))
     #*exp(-2.0*PI*CI/360.0*tempSuper(65))
      Fterm66=Fterm66+dfloat(frequency(66))
     #*exp(-2.0*PI*CI/360.0*tempSuper(66))
      Fterm67=Fterm67+dfloat(frequency(67))
     #*exp(-2.0*PI*CI/360.0*tempSuper(67))
      Fterm68=Fterm68+dfloat(frequency(68))
     #*exp(-2.0*PI*CI/360.0*tempSuper(68))
      Fterm69=Fterm69+dfloat(frequency(69))
     #*exp(-2.0*PI*CI/360.0*tempSuper(69))
      Fterm70=Fterm70+dfloat(frequency(70))
     #*exp(-2.0*PI*CI/360.0*tempSuper(70))
      Fterm71=Fterm71+dfloat(frequency(71))
     #*exp(-2.0*PI*CI/360.0*tempSuper(71))
      Fterm72=Fterm72+dfloat(frequency(72))
     #*exp(-2.0*PI*CI/360.0*tempSuper(72))
      Fterm73=Fterm73+dfloat(frequency(73))
     #*exp(-2.0*PI*CI/360.0*tempSuper(73))
      Fterm74=Fterm74+dfloat(frequency(74))
     #*exp(-2.0*PI*CI/360.0*tempSuper(74))
      Fterm75=Fterm75+dfloat(frequency(75))
     #*exp(-2.0*PI*CI/360.0*tempSuper(75))
      Fterm76=Fterm76+dfloat(frequency(76))
     #*exp(-2.0*PI*CI/360.0*tempSuper(76))
      Fterm77=Fterm77+dfloat(frequency(77))
     #*exp(-2.0*PI*CI/360.0*tempSuper(77))
      Fterm78=Fterm78+dfloat(frequency(78))
     #*exp(-2.0*PI*CI/360.0*tempSuper(78))
      Fterm79=Fterm79+dfloat(frequency(79))
     #*exp(-2.0*PI*CI/360.0*tempSuper(79))
      Fterm80=Fterm80+dfloat(frequency(80))
     #*exp(-2.0*PI*CI/360.0*tempSuper(80))
      Fterm81=Fterm81+dfloat(frequency(81))
     #*exp(-2.0*PI*CI/360.0*tempSuper(81))
      Fterm82=Fterm82+dfloat(frequency(82))
     #*exp(-2.0*PI*CI/360.0*tempSuper(82))
      Fterm83=Fterm83+dfloat(frequency(83))
     #*exp(-2.0*PI*CI/360.0*tempSuper(83))
      Fterm84=Fterm84+dfloat(frequency(84))
     #*exp(-2.0*PI*CI/360.0*tempSuper(84))
      Fterm85=Fterm85+dfloat(frequency(85))
     #*exp(-2.0*PI*CI/360.0*tempSuper(85))
      Fterm86=Fterm86+dfloat(frequency(86))
     #*exp(-2.0*PI*CI/360.0*tempSuper(86))
      Fterm87=Fterm87+dfloat(frequency(87))
     #*exp(-2.0*PI*CI/360.0*tempSuper(87))
      Fterm88=Fterm88+dfloat(frequency(88))
     #*exp(-2.0*PI*CI/360.0*tempSuper(88))
      Fterm89=Fterm89+dfloat(frequency(89))
     #*exp(-2.0*PI*CI/360.0*tempSuper(89))
      Fterm90=Fterm90+dfloat(frequency(90))
     #*exp(-2.0*PI*CI/360.0*tempSuper(90))
      Fterm91=Fterm91+dfloat(frequency(91))
     #*exp(-2.0*PI*CI/360.0*tempSuper(91))
      Fterm92=Fterm92+dfloat(frequency(92))
     #*exp(-2.0*PI*CI/360.0*tempSuper(92))
      Fterm93=Fterm93+dfloat(frequency(93))
     #*exp(-2.0*PI*CI/360.0*tempSuper(93))
      Fterm94=Fterm94+dfloat(frequency(94))
     #*exp(-2.0*PI*CI/360.0*tempSuper(94))
#endif     
...
#endif  !Ifdef ScalarVersion or Arrayversion or Array_Scalar_Version
